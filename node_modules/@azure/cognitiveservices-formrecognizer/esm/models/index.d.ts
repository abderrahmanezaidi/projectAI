 ...
 */
export declare type FieldValueUnion = FieldValue | StringValue | NumberValue;
/**
 ...
 * @enum {string}
 */
export declare type Status = 'success' | 'partialSuccess' | 'failure';
/**
 ...
 * @enum {string}
 */
export declare type Status1 = 'created' | 'ready' | 'invalid';
/**
 ...
 * @enum {string}
 */
export declare type Status2 = 'success' | 'partialSuccess' | 'failure';
/**
 * Contains response data for the trainCustomModel operation.
 */
export declare type TrainCustomModelResponse = TrainResult & {
    /**
 ...
 */
export declare type GetExtractedKeysResponse = KeysResult & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type GetCustomModelsResponse = ModelsResult & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type GetCustomModelResponse = ModelResult & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type AnalyzeWithCustomModelResponse = AnalyzeResult & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type BatchReadReceiptResponse = BatchReadReceiptHeaders & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type GetReadReceiptResultResponse = ReadReceiptResult & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type BatchReadReceiptInStreamResponse = BatchReadReceiptInStreamHeaders & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
